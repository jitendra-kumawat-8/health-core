...
import { REGISTER_HERO_CONTENT } from "./constants";
...
export const RegisterHero: React.FC<RegisterHeroProps> = ({
  headline = REGISTER_HERO_CONTENT.headline,
  subtext = REGISTER_HERO_CONTENT.subtext,
}) => {
  return (
    <Section
      maxWidth="lg"
    ...
    >
      ...
      >
        <Image
          src="/assets/register-with-us-hero.png"
          alt=""
          fill
          priority
